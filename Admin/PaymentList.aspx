<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="PaymentList.aspx.cs" Inherits="Admin_PaymentList" %>
        ...
        <tr>
            <td colspan="2">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT Paymentt.paymentid, Paymentt.auctionid, Paymentt.productid, Productt.productname, Paymentt.paymentdate, Paymentt.paymentamount, Paymentt.paymentmode FROM Paymentt INNER JOIN Productt ON Paymentt.productid = Productt.productid">
