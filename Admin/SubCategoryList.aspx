<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="SubCategoryList.aspx.cs" Inherits="Admin_SubCategoryList" %>
        ...
        <tr>
            <td colspan="2">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Edit" ItemStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                          <a href='EditSubCategory.aspx?SCAID=<%#Eval("SubCategoryId")%>' style="font-family: Arial, Helvetica, sans-serif; font-size: medium; font-weight: bold; color:#1890C6;">Edit</a>
                                 </ItemTemplate>
                            </asp:TemplateField>
                    </Columns>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    SelectCommand="SELECT SubCategoryt.SubCategoryId, SubCategoryt.SubCategoryName, Categoryt.CategoryName, SubCategoryt.SubCategoryImage FROM Categoryt INNER JOIN SubCategoryt ON Categoryt.CategoryId = SubCategoryt.CategoryId order by SubCategoryt.SubCategoryId">
                </asp:SqlDataSource>
            </td>
        </tr>
        <tr>
