...
public partial class Admin_AddProduct : System.Web.UI.Page
{
    ...
    protected void addbtn_Click(object sender, EventArgs e)
    {
        ...
        isql = "INSERT INTO productt (productid,productname, productimage, description, startdate, enddate, startbid, increment, productstatus, subcategoryid, uploadedby) VALUES ('"
                        + pidtxt.Text + "' , '"
                        + pnametxt.Text + "' , '"
                        + fpath + "' , '"
                        + pdesctxt.Text + "' , '"
                        ...
                        + pedatetxt.Text + "' , "
                        + pbidamttxt.Text + " , "
                        + pincrtxt.Text + " , 'Not Verified', "
                        + subcatddl.SelectedValue + " , '"
